A pair of isomorphic graph is two graphs that is exactly the same, even though the ordering/position of the vertix can be different that make it confusing!
