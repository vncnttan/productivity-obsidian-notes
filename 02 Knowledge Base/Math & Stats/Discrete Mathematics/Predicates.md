Predicates are statements that is neither true nor false w/ variables that are not specified inside of it. The truth value is dependent on the value inside of those variables.
	example:
	`x > 3`
