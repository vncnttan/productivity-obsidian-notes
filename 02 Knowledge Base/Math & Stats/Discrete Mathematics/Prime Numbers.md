Prime number is an integer that is greater than 1 if the the only factors of it is 1 and the number itself. (The number is not divisible by any more number)
