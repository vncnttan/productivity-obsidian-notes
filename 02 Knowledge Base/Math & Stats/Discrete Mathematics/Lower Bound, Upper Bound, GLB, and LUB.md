Upper bound of an element is points that are connected with the element that is upper the element. Upper Bound of a a pair of element is how those element intersect
